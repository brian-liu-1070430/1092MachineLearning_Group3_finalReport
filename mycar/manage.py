...
from donkeycar.parts.keras import Mymodel
...
import donkeycar.parts.cv as dkcv
...
def drive(cfg, model_path=None, use_joystick=False, model_type=None,
    ...
    if camera_type == "stereo":
        ...
        gray = dkcv.ImgGreyscale()
        canny = dkcv.ImgCanny(low_threshold = 100 ,high_threshold=130)
        cut = dkcv.Imgcut(x=0, y=40)
        V.add(gray, inputs=['cam/image_array'], outputs=['cam/image_array'], threaded=False)
        # V.add(canny, inputs=['cam/image_array'], outputs=['cam/image_array'], threaded=False)
        V.add(cut, inputs=['cam/image_array'], outputs=['cam/image_array'], threaded=False)
